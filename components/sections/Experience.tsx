  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center flex-shrink-0 w-8">
        ...
        <div
          ...
          style={{
            ...
            border: `2px solid ${exp.current ? 'var(--primary)' : 'color-mix(in srgb, var(--primary) 45%, var(--border))'}`,
        ...
        {!isLast && (
          <div
            ...
            style={{
              background: 'linear-gradient(to bottom, color-mix(in srgb, var(--primary) 45%, var(--border)), transparent)',
              minHeight: '24px',
            }}
          />
        )}
      ...
      <div className="flex-1 mb-8">
        <TiltCard maxTilt={6} radius="16px">
          <div
