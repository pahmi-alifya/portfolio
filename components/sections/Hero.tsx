  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% 50%, var(--primary-glow) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        >
          <span
            ...
            style={{ background: '#4ade80', boxShadow: '0 0 6px #4ade80', animation: 'glow-pulse 2s ease infinite' }}
          />
        ...
        <p
          ...
          style={{ color: 'var(--text-muted)', animation: 'badge-reveal 0.6s ease 0.2s both' }}
        >
          Hi, I&apos;m
        </p>
        ...
        <div
          ...
          style={{ color: 'var(--accent)', fontFamily: 'var(--font-space-grotesk)', animation: 'badge-reveal 0.6s ease 0.8s both', opacity: 0 }}
        >
          <span>{displayed}</span>
        ...
        <p
          ...
          style={{ color: 'var(--text-muted)', animation: 'badge-reveal 0.6s ease 1s both', opacity: 0 }}
        >
          Building scalable web & mobile experiences with React, Next.js, and React Native.
          5+ years crafting products that millions use.
        </p>

        {/* Meta */}
        <div
          className="flex items-center justify-center gap-4 mb-8 text-sm"
          style={{ color: 'var(--text-faint)', animation: 'badge-reveal 0.6s ease 1.1s both', opacity: 0 }}
        >
        ...
        >
          {[
            { href: 'https://github.com/pahmi-alifya', icon: GithubIcon, label: 'GitHub' },
            { href: 'https://www.linkedin.com/in/pahmi-alifya-bahri-479a0919a/', icon: LinkedinIcon, label: 'LinkedIn' },
      ...
      <a
        ...
        style={{ color: 'var(--text-faint)', animation: 'badge-reveal 0.6s ease 1.8s both', opacity: 0 }}
      >
